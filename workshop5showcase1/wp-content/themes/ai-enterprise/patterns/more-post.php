...
/**
 * Title: More Post
 * Slug: ai-enterprise/more-post
 * Categories: ai-enterprise, more-post
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('More Articles &amp; Posts','ai-enterprise'); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:post-title {"textAlign":"left","level":4,"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading"}}}},"textColor":"heading"} /-->
